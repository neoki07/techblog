...
https://github.com/neokidev/homebrew-tap
...
class GitCo < Formula
  ...
  homepage "https://github.com/neokidev/git-co"
  url "https://github.com/neokidev/git-co/releases/download/v0.3.0/git-co-0.3.0-x86_64-apple-darwin.tar.gz"
...
```sh
brew install neokidev/tap/git-co
```
...
https://github.com/neokidev/git-co
