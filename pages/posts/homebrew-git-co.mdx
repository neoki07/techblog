...
https://github.com/ot07/homebrew-tap
...
class GitCo < Formula
  ...
  url "https://github.com/ot07/git-co/releases/download/v0.3.0/git-co-0.3.0-x86_64-apple-darwin.tar.gz"
